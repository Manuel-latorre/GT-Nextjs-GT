    ...
    <div className={montserrat.className}>
        <div className='container-faqs-solucion'>
            <div className='container-texto-faqs'>
                ...
                <p  className='bodyFq'>Podes contactarnos completando el formulario desde la sección de <a className='btnContactoFaqs' href="https://wa.me/541150034462?text=¡Hola%20Generacion%20Tech!%20Me%20gustaría%20saber%20acerca%20de..." target="_blank">CONTACTO</a> o simplemente tocar en el botón de chat de nuestra página para hablar con un representante en tiempo real.</p>
