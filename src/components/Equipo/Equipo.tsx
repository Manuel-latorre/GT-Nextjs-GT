...
const guiso = require('../../assets/guiso.png')
// import manu from '../../assets/manu.png'
const manu = require('../../assets/manu.png')
// import pao from '../../assets/pao.png'
const pao = require('../../assets/pao.png')
// import juli from '../../assets/juli.png'
const juli = require('../../assets/juli.png')
                    ...
                    <div className="cardEquipo">
                        ...
                        <div className='rolContainer'>
                            <div style={{ marginTop: 10 }}>
                                ...
                                <hr />
                                <p className={`${montserrat.className} rolDescription`}>Diseño, desarrollo y mantenimiento los sitios webs del lado del cliente</p>
                            </div>
                            <div style={{ marginTop: 40 }}>
