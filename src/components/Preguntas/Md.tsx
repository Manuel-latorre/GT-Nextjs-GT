  ...
  return (
    <div className="accordion_preguntas">
        <Accordion variant="bordered">
            <AccordionItem key="1" aria-label="Accordion 1" title="¿Qué beneficios tiene el marketing digital para mi empresa?">
            ...
            <AccordionItem key="2" aria-label="Accordion 2" title="¿Qué estrategia de marketing digital es la más adecuada para mi empresa?">
            ...
            <AccordionItem key="3" aria-label="Accordion 3" title="¿Qué tipo de contenido debo generar para mi página web y mis redes sociales?">
